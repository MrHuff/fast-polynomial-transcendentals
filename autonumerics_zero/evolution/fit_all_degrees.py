...
Key improvement: simulates actual FP16 Horner evaluation using numpy float16
arrays. Each multiply-add step is cast to float16, matching CUDA kernel rounding.
...
from constrained_ls_fitter import (
    dual_constrained_ls_fit, eval_poly, to_fp16_hex, max_error,
...
def eval_horner_fp16_vec(t_f64, coeffs_fp16, is_odd=True):
    """
    Vectorized FP16 Horner evaluation matching CUDA kernel behavior.

    Each intermediate result is cast to float16 to simulate __hfma2 rounding.
