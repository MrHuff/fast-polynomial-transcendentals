...
\begin{itemize}[leftmargin=1.4em]
    ...
    complete attention forward by 7.4\%. We release the fitting tools, packed
    kernels, portable integration and evaluation code, and supporting artifacts;
    repository and reproduction details appear in \cref{app:reproducibility}.
